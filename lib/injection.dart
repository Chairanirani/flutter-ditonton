...
Future<void> init({http.Client? httpClient}) async {
  print('DI_DEBUG: 1. mulai init DI...');

  // cek http.Client sdh terdaftar
  ...
  print('DI_DEBUG: 2. register movie providers');
  // provider
  ...
  print('DI_DEBUG: 3. register movie use cases');
  // use case
  ...
  print('DI_DEBUG: 4. register movie repository & datasource');
  // repository
  ...
  print('DI_DEBUG: 5. register helper database');
  // helper
  ...
  print('DI_DEBUG: 6. register TV series providers');
  // TV SERIES DEPENDENCIES
  // provider
  locator.registerFactory(
  ...
  print('DI_DEBUG: 7. register TV series use cases');
  // use cases
  ...
  print('DI_DEBUG: 8. register tv series repo dan data');
  // repository
  ...
  print('DI_DEBUG: 9. selesai init DI');
}
